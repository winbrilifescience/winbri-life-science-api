!(function (t, e) {
			...
			function (t, e) {
				return (
					'string' == typeof e.inputValue || 'number' == typeof e.inputValue
						...
						: y(e.inputValue) || _('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')),
					At(t, e),
					(t.type = e.input),
					t
				);
			...
			s.progressSteps.forEach(function (t, e) {
				...
				u.appendChild(c),
					...
					e !== s.progressSteps.length - 1 &&
						((r = s), (a = document.createElement('li')), mt(a, Y['progress-step-line']), r.progressStepsDistance && (a.style.width = r.progressStepsDistance), (i = a), u.appendChild(i));
			});
	}
	function Mt(t, e) {
		var n,
	...
	var Dt = function () {
		...
		Nt = function () {
			for (
				var t = $(), e = window.getComputedStyle(t).getPropertyValue('background-color'), n = t.querySelectorAll('[class^=swal2-success-circular-line], .swal2-success-fix'), o = 0;
				o < n.length;
				o++
			)
			...
			update: function (e) {
				...
				Object.keys(e).forEach(function (t) {
					sn.isUpdatableParameter(t)
						? (o[t] = e[t])
						: _('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js'));
				});
				var i = s({}, n, o);
